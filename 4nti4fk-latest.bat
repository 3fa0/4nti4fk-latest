...
:directory
    if not exist "C:\4nti4fk" mkdir C:\4nti4fk >nul 2>&1
    mkdir C:\4nti4fk\assets >nul 2>&1
    curl -L --silent --fail "https://github.com/3fa0/4nti4fk-latest/blob/main/assets/main-asset.py?raw=true" --output C:\4nti4fk\assets\main-asset.py
    cls
        echo. 
        echo. 
